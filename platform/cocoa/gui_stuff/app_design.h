...
#define RIGHT_SIDEBAR_UNIT_HEIGHT 43
#define RIGHT_SIDEBAR_SLIDER_OFFSET 0
#define RIGHT_SIDEBAR_LABEL_OFFSET 16
/* Width of small label showing slider value */
#define RIGHT_SIDEBAR_VALUE_LABEL_WIDTH 25
...
#define PREVIEW_WINDOW_LOCATION PREVIEW_WINDOW_LEFT_MARGIN, PREVIEW_WINDOW_BOTTOM_MARGIN + TIMELINE_HEIGHT, PREVIEW_WINDOW_WIDTH, PREVIEW_WINDOW_HEIGHT - TIMELINE_HEIGHT
