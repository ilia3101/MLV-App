...
private slots:
    ...
    void on_horizontalSliderClearance_valueChanged(int position);
    ...
    void on_horizontalSliderClearance_doubleClicked();
    ...
    void on_label_ClearanceVal_doubleClicked( void );
