...
#ifndef _DarkStyleModern
#define _DarkStyleModern
...
public:
  static void assign()
  {
    ...
    // loadstylesheet
#ifdef WIN32
    QFile qfDarkstyle(QString(":/darkstyle/darkstyleModern.qss"));
#else
    QFile qfDarkstyle(QString(":/darkstyle/darkstyleModernOSX.qss"));
#endif
