...
enum export_mode { MLV_FAST_PASS, MLV_COMPRESS, MLV_DECOMPRESS, MLV_AVERAGED_FRAME, MLV_DF_INT, MLV_CINEFORM, MLV_JP2K_LOW, MLV_JP2K_MED, MLV_JP2K_HIGH, MLV_JP2K_VERYHIGH, MLV_JP2K_VISULOSSLESS };
/* from darkframe.c */
