...
/* From http://www.cvrl.org/, 10 degree 1964 values */
...
void kelvin_to_XYZ(double temperature, double * XYZ_out)
{
...
//    memcpy(temp_matrix_a, temp_matrix_b, 9 * sizeof(double));
    ...
    kelvin_to_XYZ(6500, k1);
    kelvin_to_XYZ(processing->kelvin, k2);
