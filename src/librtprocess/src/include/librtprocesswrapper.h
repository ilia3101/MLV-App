...
void lrtpLmmseDemosaic( float ** restrict rawData, float ** restrict red, float ** restrict green, float ** restrict blue, int width, int height, int iterations );
...
void lrtpDcbDemosaic( float ** restrict rawData, float ** restrict red, float ** restrict green, float ** restrict blue, int width, int height, int iterations );
